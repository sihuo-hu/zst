layui.use(['layer', 'form', 'table', 'ztree', 'laydate', 'admin', 'ax'], function () {
    ...
    MarCashCoupon.initColumn = function () {
        return [[
            ...
            {field: 'createTime', minWidth:180 ,  title: '创建日期'},
            {field: 'ccName',  title: '名称'},
            {field: 'ccMoney',  title: '金额'},
            {field: 'ccScopeId',  title: '使用范围'},
            {field: 'grantMode',  title: '发放方式'},
            {field: 'grantCondition', title: '发放条件'},
            {field: 'startTime', minWidth:180 ,  title: '生效日期'},
            {field: 'pastDueMode', title: '失效方式'},
            {field: 'pastDueTime', minWidth:180 ,  title: '失效日期'},
            {field: 'amountToMark',  title: '达标金额'},
            {field: 'ccExplain',  title: '说明'},
            {field: 'ccStatus',  templet: '#statusTpl', title: '状态'},
