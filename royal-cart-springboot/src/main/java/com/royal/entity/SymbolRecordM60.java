 ...
 */
@Data
@Table(name = "r_symbol_record_m60")
public class SymbolRecordM60 implements Serializable {

    public SymbolRecordM60(String marketTime, String symbolCode, BigDecimal symbolOpen, BigDecimal symbolClose, BigDecimal symbolMin, BigDecimal symbolMax, BigDecimal symbolTurnover) {
