 ...
 */
@Data
@Table(name = "r_symbol_record_m15")
public class SymbolRecordM15 implements Serializable {

    public SymbolRecordM15(String marketTime, String symbolCode, BigDecimal symbolOpen, BigDecimal symbolClose, BigDecimal symbolMin, BigDecimal symbolMax, BigDecimal symbolTurnover) {
