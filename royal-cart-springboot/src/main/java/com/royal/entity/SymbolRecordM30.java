 ...
 */
@Data
@Table(name = "r_symbol_record_m30")
public class SymbolRecordM30 implements Serializable {

    public SymbolRecordM30(String marketTime, String symbolCode, BigDecimal symbolOpen, BigDecimal symbolClose, BigDecimal symbolMin, BigDecimal symbolMax, BigDecimal symbolTurnover) {
