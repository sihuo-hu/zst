 ...
 */
@Data
@Table(name = "r_symbol_record_d7")
public class SymbolRecordD7 implements Serializable {

    public SymbolRecordD7(String marketTime, String symbolCode, BigDecimal symbolOpen, BigDecimal symbolClose, BigDecimal symbolMin, BigDecimal symbolMax, BigDecimal symbolTurnover) {
