 ...
 */
@Data
@Table(name = "r_symbol_record_h4")
public class SymbolRecordH4 implements Serializable {

    public SymbolRecordH4(String marketTime, String symbolCode, BigDecimal symbolOpen, BigDecimal symbolClose, BigDecimal symbolMin, BigDecimal symbolMax, BigDecimal symbolTurnover) {
