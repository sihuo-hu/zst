 ...
 */
@Data
@Table(name = "r_symbol_record_m5")
public class SymbolRecordM5 implements Serializable {

    public SymbolRecordM5(String marketTime, String symbolCode, BigDecimal symbolOpen, BigDecimal symbolClose, BigDecimal symbolMin, BigDecimal symbolMax, BigDecimal symbolTurnover) {
